        ...
        <div className="max-w-6xl mx-auto px-4">
            <div className="flex justify-center gap-6 md:gap-8 mb-6">
                <Link
                    ...
                    className="text-gray-400 hover:text-white transition-all-smooth hover:scale-110 p-2 rounded-lg hover:bg-gray-800/50"
                    aria-label="GitHub"
                >
            ...
            <p className="text-center text-gray-500 text-sm">
                © 2025 Safa Demirkan. Built with Next.js & deployed on Vercel.
            </p>
        </div>
    </footer>
);