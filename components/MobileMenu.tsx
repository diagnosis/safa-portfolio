...
export const MobileMenu = () => {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-0 right-0 h-screen w-64 bg-[#111827] border-l border-gray-700 shadow-2xl z-[9998] transform transition-transform duration-300 ease-in-out lg:hidden ${
